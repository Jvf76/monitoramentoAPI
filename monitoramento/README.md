...
2. Selecione `MonitoramentoApplication`.
3. Abra `Environment variables`.
4. Adicione `DB_PASSWORD` com a senha do usuário `root`.

## Como executar

1. Clone ou extraia o projeto.
2. Crie o banco `monitoramento_industrial`.
3. Configure a variável `DB_PASSWORD`.
4. Execute a classe `MonitoramentoApplication`.
5. Acesse:
